...
const Navigation = () => {
  ...
  return <div className="fixed bottom-10 left-[20rem] 
  transform translate-x-1/2 translate-y-1/2 z-50 bg-[#264653]  ##Charcoal Blue
  border w-[30%] px-[4rem] mb-[2rem] rounded">
